...
This project monitors an AWS account and sends email alerts whenever someone logs into the console.
...
Terraform Init — connects to the S3 backend and downloads providers
Terraform Validate — checks the code for errors
Terraform Plan — shows what will change before touching anything
...
Create a terraform.tfvars file with your details:
...
Confirm the SNS subscription email that gets sent to your inbox
Log out and back into AWS to trigger a test alert
